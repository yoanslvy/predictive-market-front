...
function ModalTitle({ status }: { status: string }) {
  const titleConfig = {
    pending: {
      Icon: Loader,
      text: 'Creating Your Vesting',
      className: 'animate-spin',
    },
    success: {
      Icon: TickInFilledCircle,
      text: 'Vesting Created',
      className: '',
    },
    error: {
...
const PendingContent = () => (
  <div className="flex flex-col items-center justify-center gap-y-[1rem]">
    <p className="text-[16px] text-[#757A8B]">
      Please wait while we process and set up your vesting. This might take a few moments. Do not
  ...
  <div className="flex flex-col items-center justify-center gap-y-[1rem]">
    <div>
      <span className="contents text-[16px] text-[#757A8B]">
        Your setup is complete. You can now manage your vesting.
      </span>
    </div>
