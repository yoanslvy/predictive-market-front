...
import { StepsFlux, useVestingStore } from '../_hooks/useVestingStore'
...
export function CheckoutSteps({
  ...
  const { fluxSettings, tokenSymbol, activeFluxes } = useVestingStore((s) => ({
    ...
    activeFluxes: s.activeFluxes as StepsFlux[],
  }))
              ...
              <CheckoutTable
                ...
                {activeFluxes.map((flux, idx) => (
                  <tr
                    ...
                    <td className="table-cell h-[4rem] px-[1rem] align-middle text-white">
                      <div className="flex items-center w-full h-full">
                        <span className="min-w-max">{dateFormatter(flux.endDate)}</span>
                      </div>
                    </td>
                    <td className="table-cell h-[4rem] px-[1rem] align-middle text-white">
                      <div className="flex items-center w-full h-full">
                        <span className="min-w-max">{flux.steps}</span>
                      </div>
                    </td>
                    <td className="table-cell h-[4rem] px-[1rem] align-middle text-white">
                      <div className="flex items-center w-full h-full">
