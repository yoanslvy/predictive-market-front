...
const PendingContent = () => (
  <div className="flex flex-col items-center justify-center gap-y-[1rem]">
    <p className="text-[16px] text-[#757A8B]">
      Increasing your allowance. Please wait while we process and approve your token. This might
...
const SuccessContent = ({
  ...
  <div className="flex flex-col items-center justify-center gap-y-[1rem]">
    <div>
      <span className="contents text-[16px] text-[#757A8B]">Approval successful!</span>
    </div>
    <div className="flex w-full flex-col items-center justify-between gap-[1rem]">
      <Btn as="button" onClick={closeModal} variant="white" className="flex w-full">
        <span className="text-center text-[16px] text-black font-bold w-full">
          Back to the airdrop creation process
        </span>
      </Btn>
      <Btn
        as="link"
...
export function CheckoutModalApproveAirdrop({
  modalOpened,
  onClose,
  wallet,
  status,
