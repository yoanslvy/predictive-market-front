...
export function CheckoutLinear({
  chainId,
  vestingContract,
  tokenAddress,
  wallet,
  ...
  const { activeRecipients, startDate, tokenSymbol, fluxSettings, endDate } = useAirdropStore(
    (s) => ({
    ...
    <>
      <div className="flex w-full flex-col items-start gap-x-[1rem] gap-y-[1.5em] mt-[2em]">
        ...
        <div className="w-full">
          <CheckoutDateInfo startDate={startDate} endDate={endDate} />
        </div>
