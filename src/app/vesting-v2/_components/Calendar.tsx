  ...
  ({ onClick, icon, disabled, ...props }: NavigationButtonProps, forwardedRef) => {
    ...
    return (
      <button
        ...
        disabled={disabled}
        className={cx(
          'flex size-8 shrink-0 select-none items-center justify-center rounded-lg border p-1 outline-hidden transition sm:size-[30px]',
          // text color
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: 'w-9 font-medium text-sm sm:text-xs text-center text-gray-600 pb-2',
        row: 'w-full mt-0.5',
        cell: cx('relative p-0 text-center focus-within:relative', 'text-gray-50'),
        day: cx(
        ...
        day_selected: cx('rounded-sm', 'aria-selected:bg-[#01EB5A29] aria-selected:text-[#01EB5A]'),
        day_disabled: '!text-gray-700 line-through disabled:hover:bg-transparent',
          ...
          return (
            <div className="flex items-center justify-between">
              ...
              <div
                role="presentation"
                aria-live="polite"
                className="text-sm font-medium capitalize tabular-nums text-gray-50">
              ...
              {today && (
                <span
                  className={cx(
                    ...
                    {
                      'bg-[#01EB5A29]': !selected,
                      'bg-gray-950!': selected,
                      'bg-gray-600!': selected && range_middle,
