...
import {
  ...
  RecipientPanelMonthlyUnlocks,
  RecipientPanelProps,
  RecipientPanelSteps,
  RecipientPanelTimelock,
  RecipientPanelUnlockCliff,
} from './RecipientPanel'
...
> = {
  ...
  unlockCliff: (props) => <RecipientPanelUnlockCliff {...props} />,
  monthlyUnlocks: (props) => <RecipientPanelMonthlyUnlocks {...props} />,
  timelock: (props) => <RecipientPanelTimelock {...props} />,
  unlockInSteps: (props) => <RecipientPanelSteps {...props} />,
  // backweighted: (props) => null,
  cliff: (props) => <RecipientPanelCliff {...props} />,
  cliffExponential: (props) => <RecipientPanelCliff {...props} />,
  exponential: (props) => <RecipientPanelLinear {...props} />,
}

const entriesPerPage = 300

export function RecipientsListWithAccordion<T extends RecipientList[]>({
  filteredRecipients,
  setRecipients,
  className,
  tokenPriceUsd,
