...
const searchParamsSchema = z.object({
  ...
  onlyClaimable: z.enum(['true', 'false']).optional().default('false'),
...
export default async function FluxPage({ searchParams }: Props) {
  ...
  const { chain, wallet, page, filter, direction, onlyClaimable, chainFilter } = parsedParams.data
  ...
  return (
    <VestingDashboardView
      ...
      filter={filter}
      direction={direction}
      onlyClaimable={onlyClaimable === 'true'}
